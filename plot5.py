...
u = np.loadtxt('Data/output5')
param = np.loadtxt('Parameters/input5')
...
fig.suptitle('2D Linear Convection')
...
ax1.set_ylabel('Time')
ax1.set_yticks(np.linspace(0, nt * dt, 5))
...
ax2.set_ylabel('Time')
ax2.set_yticks(np.linspace(0, nt * dt, 5))
